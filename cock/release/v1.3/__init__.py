...
first = ['Holy', 'Shitty', 'Jizzy', 'Still', 'Fucking', 'Jaevla', 'Moronic', 'Foul-smelling', 'Drunken'];
second = [' wanking ', ' shagging ', ' fucking ', ' hacking ', ' cunting ', ' unwashed ', ' Mac-using ', ' jizzing ', ' sharting ', ' elephant ', ' duck ']
third = ['assballs!', 'dick!', 'anyway!', 'twat!', 'NetBSD!', 'buggery!', 'Mac users!', 'arseboggins!', 'lille lort!', 'douche!', 'douchebag!', 'fuck!']
